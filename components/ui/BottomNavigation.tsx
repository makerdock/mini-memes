...
export function BottomNavigation() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-black/80 border-t-2 border-cyan-400 backdrop-blur-md flex justify-around items-center h-16 md:hidden">
